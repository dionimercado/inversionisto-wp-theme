...
<div class="property_listing h-100 w-100">
  ...
  <?php endif; ?>
  <?php //echo get_post_meta(get_the_ID(), 'sticky', true) ?>
  ...
  <a href="<?php the_permalink() ?>">
    <figure>
      ...
      <figcaption>
        <h4>
          <svg style="margin-top: -3px;" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24">
          <path fill="#016600" d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/>
          <path d="M0 0h24v24H0z" fill="none"/>
        </svg>
        <?php echo $property_area[0]->name ?></h4>
      </figcaption>
    </figure>
