...
function property_action() {
	...
	$labels = array(
		'name'                       => _x( 'Acciones', 'Taxonomy General Name', 'inversionisto' ),
		'singular_name'              => _x( 'Acción', 'Taxonomy Singular Name', 'inversionisto' ),
		'menu_name'                  => __( 'Acciones', 'inversionisto' ),
	...
	register_taxonomy( 'prop_action', array( 'property' ), $args );

}
add_action( 'init', 'property_action', 0 );
